...
public class RecetaBean implements Serializable {
    ...
    public void agregarIngredienteANuevaReceta() {
        try {
            ...
            if (nuevaReceta.getIngredientes() == null) nuevaReceta.setIngredientes(new ArrayList<>());
    ...
    public void removerIngredienteDeNuevaReceta(Integer codigo) {
        if (codigo == null || nuevaReceta.getIngredientes() == null) return;
    ...
    public void crearReceta() {
        try {
            ...
            // asegurar tiempoPreparacion mínimo = 0
            if (nuevaReceta.getTiempoPreparacion() == null) nuevaReceta.setTiempoPreparacion(0);
            ...
            if (resp.statusCode() >= 200 && resp.statusCode() < 300) {
                ...
                FacesContext.getCurrentInstance().addMessage(null,
                        new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error", "No se pudo crear la receta. Código: " + resp.statusCode()));
            }
    ...
    public void eliminarReceta(Integer id) {
        try {
            ...
            if (resp.statusCode() >= 200 && resp.statusCode() < 300) {
                ...
                FacesContext.getCurrentInstance().addMessage(null,
                        new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error", "No se pudo eliminar la receta. Código: " + resp.statusCode()));
            }
            cargarRecetas();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public RecetaDTO getRecetaSeleccionada() { return recetaSeleccionada; }
    public void setRecetaSeleccionada(RecetaDTO recetaSeleccionada) { this.recetaSeleccionada = recetaSeleccionada; }

    public RecetaDTO getNuevaReceta() { return nuevaReceta; }
    public void setNuevaReceta(RecetaDTO nuevaReceta) { this.nuevaReceta = nuevaReceta; }

    public List<IngredienteDTO> getIngredientesDisponibles() { return ingredientesDisponibles; }
    public void setIngredientesDisponibles(List<IngredienteDTO> ingredientesDisponibles) { this.ingredientesDisponibles = ingredientesDisponibles; }
    ...
    public Integer getSelectedIngredienteCantidad() { return selectedIngredienteCantidad; }
    public void setSelectedIngredienteCantidad(Integer selectedIngredienteCantidad) { this.selectedIngredienteCantidad = selectedIngredienteCantidad; }
}
