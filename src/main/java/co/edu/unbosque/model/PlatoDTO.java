...
public class PlatoDTO {
    ...
    public PlatoDTO() { super(); }

    public PlatoDTO(Integer platoId, String nombre, Integer precioVenta, Integer margenGanancia, Integer costo, String imagen, Integer recetaId) {
    ...
    public String toString() {
        return "PlatoDTO [platoId=" + platoId + ", nombre=" + nombre + ", precioVenta=" + precioVenta
                + ", margenGanancia=" + margenGanancia + ", costo=" + costo + ", recetaId=" + recetaId
                + ", imagen=" + imagen + "]";
    }
}
